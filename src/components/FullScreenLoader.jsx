...
export default function FullScreenLoader() {
  return (
    <div
      ...
      className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#03111b] px-6 py-10 text-white"
    >
      ...
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center gap-10">
        <div className="space-y-4 text-center">
          <p className="text-[0.7rem] font-medium uppercase tracking-[0.65em] text-cyan-100/70">
            Puget Sound Creel
          </p>
          ...
          {statusItems.map((item, index) => (
            ...
            >
              <div className="mb-3 flex items-center gap-3">
                <div
                  className="creel-loader-dot h-2.5 w-2.5 rounded-full bg-cyan-100 shadow-[0_0_16px_rgba(126,229,255,0.9)]"
